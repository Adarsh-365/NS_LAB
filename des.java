...
public class des {
  ...
  public static String encrypt(String pt,ArrayList<String> rkb, ArrayList<String> rk ){
...
static int key_comp[] = {14, 17, 11, 24, 1, 5,
  ...
  public static void main(String[] args) {
      ...
      String left = keynew.substring(0,28);
      String right = keynew.substring(28);
      
     
      ArrayList<String> rkb = new ArrayList<String>();
      ArrayList<String> rk = new ArrayList<String>();
      for(int i=0;i<16;i++){
          String templeft = shift_left(left, shift_table[i]);
          String tempright = shift_left(right, shift_table[i]);
     ...
     String encrypted = encrypt(pt,rkb,rk); 
     ...
     String text = encrypt(cipher_text,rkb,rk); 
